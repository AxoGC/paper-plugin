...
```
src/main/kotlin/com/axogc/paper/
├── PaperPlatformPlugin.kt        # 插件入口，生命周期管理
├── commands/
│   ├── BindCommand.kt            # /bind <CODE>
│   ├── WebCommand.kt             # /web
│   └── DocsCommand.kt            # /docs [path]
├── config/
